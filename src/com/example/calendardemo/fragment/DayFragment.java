...
import com.example.calendardemo.adapter.MomentAdapter;
import com.example.calendardemo.bean.CalendarTagBean;
import com.example.calendardemo.bean.MomentBean;
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 0:
				...
				try {
					...
					p.leftMargin = dip2px(getActivity(), 40);
